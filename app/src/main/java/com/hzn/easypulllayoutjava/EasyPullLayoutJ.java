...
public class EasyPullLayoutJ extends ViewGroup {
    ...
    public EasyPullLayoutJ(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.EasyPullLayoutJ, defStyleAttr, 0);
        trigger_offset_left = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_trigger_offset_left,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        trigger_offset_top = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_trigger_offset_top,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        trigger_offset_right = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_trigger_offset_right,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        trigger_offset_bottom = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_trigger_offset_bottom,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        max_offset_left = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_max_offset_left,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        max_offset_top = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_max_offset_top,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        max_offset_right = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_max_offset_right,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        max_offset_bottom = a.getDimensionPixelOffset(R.styleable.EasyPullLayoutJ_max_offset_bottom,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, -1f, context.getResources().getDisplayMetrics()));
        fixed_content_left = a.getBoolean(R.styleable.EasyPullLayoutJ_fixed_content_left, false);
        fixed_content_top = a.getBoolean(R.styleable.EasyPullLayoutJ_fixed_content_top, false);
        fixed_content_right = a.getBoolean(R.styleable.EasyPullLayoutJ_fixed_content_right, false);
        fixed_content_bottom = a.getBoolean(R.styleable.EasyPullLayoutJ_fixed_content_bottom, false);
        roll_back_duration = a.getInteger(R.styleable.EasyPullLayoutJ_roll_back_duration, 300);
        sticky_factor = a.getFloat(R.styleable.EasyPullLayoutJ_sticky_factor, 0.66f);
